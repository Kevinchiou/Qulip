...
public class QueryService extends Service {
	...
	public static final String MY_ACTION = "tv.goodtv.query.service";
			...
			while (true) {
				try {
					...
					if (type == 2) {
						...
						url = "http://gdata.youtube.com/feeds/api/videos?v=2&alt=jsonc&max-results=50&author=goodtv&q=" + URLEncoder.encode(keyword, "utf-8") + "&start-index=";
					}
