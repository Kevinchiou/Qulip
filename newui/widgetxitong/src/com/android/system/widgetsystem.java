...
public class widgetsystem extends AppWidgetProvider {
	//private static Time time=new Time();
		...
		public static RemoteViews getTimeView(Context context){
				 ...
				 String path = "http://rss.5286phone.com/6.xml";
			    /* ����getRss()ȡ�ý������List */
...
//		      EX08_13_1.this.finish();
		...
		public void onDeleted(Context context, int[] appWidgetIds) {
			...
			int[] appids=manager.getAppWidgetIds(new ComponentName(context, widgetsystem.class));
